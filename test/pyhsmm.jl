...
@testset "Scaled" begin
    ...
    res = forward_logsumexp(init_distn, trans_matrix, log_likelihoods)
    ...
    res = backward_logsumexp(init_distn, trans_matrix, log_likelihoods)
...
@testset "Log" begin
    ...
    res = backward_log(trans_matrix, log_likelihoods)
